    ...
    plop.setGenerator('Redux Reducer', {
        ...
        actions: () => {
            const actions = [
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/actions.ts',
                    templateFile: './config/plop/reducer/actions.js.plop',
                },
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/actions.test.ts',
                    templateFile: './config/plop/reducer/actions.test.js.plop',
                },
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/reducer.ts',
                    templateFile: './config/plop/reducer/reducer.js.plop',
                },
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/reducer.test.ts',
                    templateFile: './config/plop/reducer/reducer.test.js.plop',
                },
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/selectors.ts',
                    templateFile: './config/plop/reducer/selectors.js.plop',
                },
                {
                    type: 'pretty-add',
                    path: './src/app/store/{{camelCase reducerName}}/selectors.test.ts',
